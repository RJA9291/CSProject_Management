#!/usr/bin/env bash
# Wrap the self-contained app.html fragment into a standalone PWA index.html.
# app.html stays the single source of truth (also published as a claude.ai Artifact).
# Never hand-edit index.html — it is generated by this script.
set -uo pipefail
